        ...
        <>
            ...
            <div className="div-1 text-center mt-3 d-flex gap-4 justify-content-center mb-3">
                ...
                <Card className='cards px-1'>
                    ...
                    <Card.Body>
                        <NavLink className={'links'} to='/student'> <Card.Title>Students</Card.Title></NavLink>
                    </Card.Body>
                </Card>
                ...
                <Card className='cards px-1'>
                    ...
                    <Card.Body>
                        <NavLink className={'links'} to='/attendance'> <Card.Title>Attendance</Card.Title></NavLink>
                    </Card.Body>
                </Card>
