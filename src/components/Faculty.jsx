...
function Faculty() {
  return (
    <>
        ...
        <div class="ECE"><h4>ELECTRONICS AND COMMUNICATION ENGINEERING</h4></div>
    ...
    <img src="https://cdna.artstation.com/p/assets/images/images/054/013/744/large/nathan-rosengrun-22-witcher.jpg?1663579518" alt="mypic"></img>
      <div className='cardinfo'>
        <span className='cardname'>Mr.Shom Lodh<br></br>Assistant Professor of</span>
          ...
          <p>B.Tech, M.E.(8 years experience) <br></br>D.O.J.: 15.07.11</p>
      </div>
   </div>
 </div>   
{/* For teacher 2 */}
...
<div className='cards'>
   <div className='card'>
    <img src="https://cdna.artstation.com/p/assets/images/images/054/013/744/large/nathan-rosengrun-22-witcher.jpg?1663579518" alt="mypic"></img>
     ...
     <div class="ECE"><h4>COMPUTER SCIENCE ENGINEERING</h4></div>
     <div className='container'>

{/* For teacher 1  of row 1 of cse*/}
